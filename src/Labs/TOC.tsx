...
export default function TOC() {
    ...
    <Nav variant="pills" id="wd-toc">
        ...
        <Nav.Item> <Nav.Link href="https://github.com/tiffanywongg/kambaz-react-web-app" target="_blank" id="wd-github">My GitHub</Nav.Link> </Nav.Item>
        <Nav.Item> <Nav.Link href="https://kambaz-node-server-app.onrender.com" target="_blank" id="wd-node-server">Node Server</Nav.Link> </Nav.Item>
    </Nav>
);}
