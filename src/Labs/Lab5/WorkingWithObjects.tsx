...
export default function WorkingWithObjects() {
    const [assignment, setAssignment] = useState({
        ...
        due: "2021-10-10", completed: false, score: 10,
    });
    const ASSIGNMENT_API_URL = `${REMOTE_SERVER}/lab5/assignment`
    const [module, setModule] = useState({
        id: 2, name: "NodeJS Module",
        description: "Create module using a NodeJS server with ExpressJS",
        course: "CS4550"
    });
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <input type="checkbox" className="w-75 form-check-input" id="wd-assignment-completed"
            ...
            <a id="wd-update-module-name"
                className="btn btn-primary float-end"
                href={`${MODULE_API_URL}/title/${assignment.title}`}>
                Update Module Name
            </a>
            ...
            <a id="wd-update-module-description"
                className="btn btn-primary float-end"
                href={`${MODULE_API_URL}/title/${assignment.description}`}>
